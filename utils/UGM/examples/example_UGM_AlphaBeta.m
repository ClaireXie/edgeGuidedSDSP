...
alphaExpBetaShrinkDecode = UGM_Decode_AlphaExpansionBetaShrink(nodePot,edgePot,edgeStruct,@UGM_Decode_GraphCut,3,ICMDecoding);

figure;
imagesc(reshape(alphaExpDecode,nRows,nCols));
colormap([1 1 1;1 0 0;0 1 0;0 0 1]);
title('Alpha-Expansion Beta-Shrink Decoding of Noisy X');
fprintf('(paused)\n');
pause
